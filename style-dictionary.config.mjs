...
// Token references like "{color.brand.500}" are written relative to the
// merged tree, not "{global.color.brand.500}", so unwrap the set-name
...
const config = {
  ...
  platforms: {
    css: {
      ...
      // custom properties come out as --color-brand-500, not --colorBrand500.
